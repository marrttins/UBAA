...
<div class="auth-card" style="max-width: 450px;">
    ...
    <p class="subtitle" style="margin-bottom: 24px;">We sent a 6-digit verification code to <strong>{{ session('password_reset_email') }}</strong>. Enter the code and your new password below.</p>
    ...
    <form method="POST" action="{{ route('forgot.password.verify.post') }}">
        ...
        <button type="submit" class="btn-submit">
            Reset Password & Login <i class="fa-solid fa-circle-check"></i>
        </button>
    </form>

    <div class="auth-alt" style="margin-top: 24px; padding-top: 16px;">
        <form method="POST" action="{{ route('forgot.password.resend_otp') }}" style="display: inline;">
            @csrf
