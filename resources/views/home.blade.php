...
@section('content')
        ...
        <div class="container">
            <div class="hero-grid">
                <div class="hero-text">
                    ...
                    <p>Welcome to the official digital hub of the University of Benin Alumni Association, Lagos Branch. <br>
                        Connect, collaborate, and contribute to our shared excellence.</p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        @auth
                            <a href="{{ route('dashboard') }}" class="btn btn-primary w-full sm:w-auto justify-center">Dashboard
                                <i class="fa-solid fa-arrow-right"></i></a>
                        @else
                            <a href="{{ route('membership') }}" class="btn btn-primary w-full sm:w-auto justify-center">View
                                Benefits <i class="fa-solid fa-star"></i></a>
                            <a href="{{ route('signup') }}" class="btn btn-outline w-full sm:w-auto justify-center">Join Lagos
                                Branch</a>
                        @endauth
                    </div>
                </div>
    ...
    <section id="benefits">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="max-width: 700px; margin: -30px auto 40px; color: var(--text-gray);">Of course there are a whole
                    lot to gain as an active member of the Association.</p>
            </div>
    ...
    <section id="team" style="background: var(--accent);">
        <div class="container">
            ...
            <h3
                style="color: var(--primary); margin-bottom: 30px; border-left: 5px solid var(--secondary); padding-left: 15px;">
                Lagos Branch Leadership</h3>
            <div class="team-grid">
                @php
                    $roleNames = [
                ...
                @foreach($executives as $exec)
                    <div class="team-card">
                        <div class="team-img">
                            <img src="{{ $exec->avatar_url ? asset($exec->avatar_url) : 'https://ui-avatars.com/api/?name=' . urlencode($exec->name) . '&background=D4AF37&color=4A0E4E' }}"
                                alt="{{ $exec->name }}">
                        </div>
                        <div class="team-info">
                            <h5>{{ $exec->name }}</h5>
                            <p>{{ $roleNames[$exec->role] ?? ucwords(str_replace('_', ' ', $exec->role)) }}</p>
                            @if($exec->phone)
                ...
                @if($executives->isEmpty())
                    <div class="team-card">
                        <div class="team-img"><img
                                src="https://ui-avatars.com/api/?name=Lagos+Exco&background=D4AF37&color=4A0E4E" alt=""></div>
                        <div class="team-info">
                            <h5>Branch Excos</h5>
    ...
    <section id="gallery">
        <div class="container">
            ...
            <div style="text-align: center;">
                <a href="{{ route('gallery') }}" class="btn btn-outline">See More Gallery <i
    ...
    <section id="jobs">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="max-width: 700px; margin: -30px auto 40px; color: var(--text-gray);">Exclusive professional
                    opportunities shared within our network. Hire an Alumnus or find your next breakthrough.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                @forelse($jobs as $job)
                    <div class="benefit-card">
                        <div class="benefit-icon"><i class="fa-solid fa-briefcase"></i></div>
                        <div class="benefit-info">
                            <h4 class="flex justify-between items-center text-sm md:text-base font-bold">{{ $job->title }} <span
                                    class="text-[9px] bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-black uppercase">{{ $job->location }}</span>
                            </h4>
                            <p class="text-xs md:text-sm font-medium text-gray-500">{{ $job->company }} •
                                {{ $job->salary_range ?? 'Salary Undisclosed' }}</p>
                            <a href="{{ route('jobs') }}"
                                class="text-[10px] font-black text-primary uppercase mt-3 inline-block">View Details <i
                ...
                @empty
                    <div class="benefit-card">
                        <div class="benefit-icon"><i class="fa-solid fa-briefcase"></i></div>
                        <div class="benefit-info">
                            <h4 class="flex justify-between items-center text-sm md:text-base font-bold">Senior Project Manager
                                <span
                                    class="text-[9px] bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-black uppercase">Remote</span>
                            </h4>
                            <p class="text-xs md:text-sm font-medium text-gray-500">Techno-Link Solutions • ₦800k - 1.2M / mo
                            </p>
                            <a href="{{ route('jobs') }}"
                                class="text-[10px] font-black text-primary uppercase mt-3 inline-block">View Details <i
                                    class="fa-solid fa-chevron-right"></i></a>
                    ...
                    <div class="benefit-card">
                        ...
                        <div class="benefit-info">
                            <h4 class="flex justify-between items-center text-sm md:text-base font-bold">Fullstack Engineer
                                <span
                                    class="text-[9px] bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full font-black uppercase">Lagos</span>
                            </h4>
    ...
    <section id="shop" style="background: var(--accent);">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="max-width: 700px; margin: -30px auto 40px; color: var(--text-gray);">Rock the UNIBEN pride.
                    Official alumni apparel, keepsakes, and heritage items available for order.</p>
            </div>

            <div
                style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 20px; margin-bottom: 20px;">
                @forelse($products as $product)
                    <a href="{{ route('shop') }}"
                        style="background: white; border-radius: 20px; overflow: hidden; border: 1px solid #f0f0f0; display: flex; flex-direction: column; text-decoration: none; transition: transform 0.3s ease, box-shadow 0.3s ease;"
                        onmouseover="this.style.transform='translateY(-5px)';this.style.boxShadow='0 15px 30px rgba(74,14,78,0.1)'"
                        onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='none'">
                        <div
                            style="height: 200px; overflow: hidden; position: relative; background: #f9fafb; display: flex; align-items: center; justify-content: center;">
                            ...
                            @if($product->original_price && $product->original_price > $product->price)
                                ...
                                <span
                                    style="position: absolute; top: 12px; left: 12px; background: #ef4444; color: white; font-size: 9px; padding: 2px 8px; border-radius: 4px; font-weight: 800;">-{{ $discount }}%</span>
                            @endif
                            @if($product->badge)
                                <span
                                    style="position: absolute; top: 12px; right: 12px; background: var(--secondary); color: var(--primary); font-size: 9px; padding: 2px 8px; border-radius: 4px; font-weight: 800;">{{ $product->badge }}</span>
                            @endif
                        </div>
                        <div style="padding: 16px; display: flex; flex-direction: column; flex-grow: 1;">
                            <span
                                style="font-size: 9px; font-weight: 800; color: var(--secondary); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 6px;">{{ $product->category }}</span>
                            <h4
                                style="font-size: 13px; font-weight: 700; color: #1f2937; margin-bottom: 12px; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; flex-grow: 1;">
                                {{ $product->title }}</h4>
                            <div style="display: flex; align-items: center; gap: 8px; margin-top: auto;">
                                @if($product->original_price)
                                    <span
                                        style="font-size: 11px; color: #d1d5db; text-decoration: line-through;">₦{{ number_format($product->original_price) }}</span>
                                @endif
                                <span
                                    style="font-size: 16px; font-weight: 900; color: var(--primary);">₦{{ number_format($product->price) }}</span>
                            </div>
                        </div>
                    </a>
                @empty
                    <div style="grid-column: 1 / -1; padding: 60px; text-align: center;">
                        <i class="fas fa-store"
                            style="font-size: 2.5rem; color: #e5e7eb; display: block; margin-bottom: 16px;"></i>
                        <p
                            style="color: #9ca3af; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; font-size: 12px;">
                            Heritage items coming soon</p>
                    </div>
                @endforelse
            </div>
                ...
                <div class="coop-text-block">
                    <div>
                        ...
                        <h2 class="section-title" style="margin-bottom: 24px;">
                            {{ $cooperative->title ?? 'Uniben Alumni Cooperative Estate' }}</h2>
                    ...
                    <div class="coop-cards-grid">
                        ...
                        <div class="coop-card">
                            ...
                            <ul class="coop-specs-list">
                                <li class="coop-spec-item"><i class="fa-solid fa-map-pin"></i> Idi-Obi, Arapagi, Bogije
                                    axis, Lagos</li>
                                <li class="coop-spec-item"><i class="fa-solid fa-maximize"></i> 500sqm per plot size</li>
                                <li class="coop-spec-item"><i class="fa-solid fa-shield-halved"></i> Global C of O & Deed
                                    included</li>
                        ...
                        <div class="coop-card">
                            ...
                            <ul class="coop-specs-list">
                                <li class="coop-spec-item"><i class="fa-solid fa-calendar-days"></i> 3-6 Months installments
                                </li>
                                ...
                                <li class="coop-spec-item"><i class="fa-solid fa-ship"></i> Waterways ferry transport access
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="coop-actions">
                        <a href="{{ route('cooperative') }}" class="btn btn-primary px-10">Learn More <i
                                class="fa-solid fa-users-gear"></i></a>
                        <a href="{{ $cooperative->application_link ?? route('cooperative') }}" class="btn btn-outline">Join
                            Society / Apply</a>
                    </div>
                </div>

                <div class="coop-image-container">
                    <img src="{{ $cooperative && $cooperative->image_url ? asset($cooperative->image_url) : asset('images/land.jpeg') }}"
                        alt="Cooperative Estate">
        ...
        <div class="container">
            <div class="bg-primary rounded-[40px] px-6 py-16 md:p-20 text-center text-white relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <p class="max-w-xl mx-auto mb-10 opacity-80 text-base md:text-lg font-medium">Your donations fuel our
                        student scholarships, infrastructure support for our Alma Mater, and welfare funds for alumni in
                        need.</p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('donate') }}" class="btn btn-secondary px-10 py-4 justify-center">Donate Now <i
                                class="fa-solid fa-heart"></i></a>
                        <a href="{{ route('home') }}#contact"
                            class="btn btn-outline border-white text-white hover:bg-white hover:text-primary px-10 py-4 justify-center">Speak
                            with us</a>
                    </div>
                </div>
                <!-- Decorative circle -->
            ...
            <div class="grid lg:grid-cols-3 gap-12 lg:gap-20">
                <div class="lg:col-span-2 space-y-8">
                    ...
                    @forelse($news as $item)
                        <a href="{{ route('news.show', $item->slug ?? $item->id) }}" class="news-card-link"
                            style="text-decoration: none; display: block;">
                            <div class="news-card-item">
                                <div class="news-card-img"
                                    style="background-image: url('{{ $item->image_url ?? 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80' }}')">
                                </div>
                                <div class="news-card-body">
                                    <span
                                        style="font-size: 12px; color: var(--secondary); font-weight: 700;">{{ $item->category ?? 'BRANCH NEWS' }}</span>
                ...
                <div id="events">
                    ...
                    @forelse($events as $event)
                        <div
                            style="background: white; padding: 20px; border-radius: 16px; margin-bottom: 16px; display: flex; gap: 20px; align-items: center; border: 1px solid rgba(0,0,0,0.03);">
                            <div
                                style="background: var(--primary); color: white; padding: 10px; border-radius: 10px; text-align: center; min-width: 60px;">
                            ...
                            <div style="flex: 1;">
                                ...
                                <p style="font-size: 11px; color: var(--text-gray);"><i class="fa-solid fa-clock"></i>
                                    {{ $event->location_name }}</p>
                            </div>
                            <div>
                                <a href="{{ route('events.detail', $event->id) }}" class="hover-bg-primary hover-text-white"
                                    style="font-size: 11px; font-weight: 800; color: var(--primary); text-decoration: none; border: 1px solid var(--primary); padding: 6px 12px; border-radius: 6px; transition: 0.3s; display: inline-block;">Details</a>
                            </div>
                        </div>
                    @empty
                    ...
                    <a href="{{ route('events') }}" class="btn btn-outline"
                        style="width: 100%; justify-content: center; margin-top: 20px;">Full Calendar</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="py-20" style="background: white;">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="max-width: 700px; margin: -30px auto 40px; color: var(--text-gray);">Have questions about
                    membership, events, or our cooperative? Reach out to us today.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-10">
                <div
                    class="text-center p-8 rounded-[32px] bg-gray-50 border border-gray-100 hover:shadow-xl transition-all group">
                    <div
                        class="w-16 h-16 bg-primary/5 rounded-2xl flex items-center justify-center text-primary text-2xl mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                        <i class="fa-solid fa-location-dot"></i>
                    </div>
                    <h4 class="font-bold text-primary mb-2">Branch Office/Secretariat</h4>
                    <p class="text-sm text-gray-500">3, Williams Carew Street,Off Sylvia Crecent <br> Anthony, Lagos State.
                    </p>
                </div>
                ...
                <div
                    class="text-center p-8 rounded-[32px] bg-gray-50 border border-gray-100 hover:shadow-xl transition-all group">
                    <div
                        class="w-16 h-16 bg-secondary/5 rounded-2xl flex items-center justify-center text-secondary text-2xl mx-auto mb-6 group-hover:bg-secondary group-hover:text-white transition-colors">
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">Hello@ubaalagos.com <br> support@ubaalagos.com</p>
                </div>
            </div>
        </div>
    </section>
